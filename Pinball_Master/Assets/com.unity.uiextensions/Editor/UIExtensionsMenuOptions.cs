    ...
    internal static class ExtensionMenuOptions
    {
        ...
        private static void SetPositionVisibleinSceneView(RectTransform canvasRTransform, RectTransform itemTransform)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(canvasRTransform,
                    new Vector2(camera.pixelWidth / 2, camera.pixelHeight / 2), camera, out var localPlanePosition)) {
        ...
        {
            GameObject horizontalScrollSnapRoot
                = CreateUIElementRoot("Horizontal Scroll Snap", menuCommand, s_ThickGUIElementSize);
        ...
        {
            GameObject verticalScrollSnapRoot
                = CreateUIElementRoot("Vertical Scroll Snap", menuCommand, s_ThickGUIElementSize);
        ...
        static public void FixedScrollSnapBase(MenuCommand menuCommand, string name,
            ScrollSnap.ScrollDirection direction, int itemVisible, int itemCount, Vector2 itemSize)
        {
            ...
            rectTransformScrollSnapRoot.sizeDelta = direction == ScrollSnap.ScrollDirection.Horizontal
            ...
            for (var i = 0; i < itemCount; i++) {
                GameObject item = CreateUIObject($"Item_{i:00}", itemList);
        ...
        {
            FixedScrollSnapBase(menuCommand, "Scroll Snap Horizontal Multiple", ScrollSnap.ScrollDirection.Horizontal,
                3, 15, new Vector2(100, 100));
        }
        ...
        {
            FixedScrollSnapBase(menuCommand, "Scroll Snap Vertical Multiple", ScrollSnap.ScrollDirection.Vertical, 3,
        ...
        {
            GameObject contentScrollSnapRoot
                = CreateUIElementRoot("Content Scroll Snap Horizontal", menuCommand, s_ThickGUIElementSize);
        ...
        {
            GameObject uiVerticalScrollerRoot
        ...
        {
            GameObject autoCompleteComboBoxRoot
            ...
            Events.UnityEventTools.AddPersistentListener<string>(inputField.GetComponent<InputField>().onValueChanged,
                new UnityEngine.Events.UnityAction<string>(autoCompleteComboBox.OnValueChanged));
            ...
            Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<Button>().onClick,
                new UnityEngine.Events.UnityAction<bool>(autoCompleteComboBox.ToggleDropdownPanel), true);
            ...
            Events.UnityEventTools.AddBoolPersistentListener(arrowButton.GetComponent<Button>().onClick,
                new UnityEngine.Events.UnityAction<bool>(autoCompleteComboBox.ToggleDropdownPanel), true);
        ...
        static public void AddComboBox(MenuCommand menuCommand)
        {
            ...
            inputFieldRT.sizeDelta = Vector2.zero;
            Events.UnityEventTools.AddPersistentListener<string>(inputField.GetComponent<InputField>().onValueChanged,
                new UnityEngine.Events.UnityAction<string>(comboBox.OnValueChanged));
            ...
            overlay.AddComponent<Image>().color = new Color(0.243f, 0.871f, 0f, 0f);
            Events.UnityEventTools.AddBoolPersistentListener(overlay.AddComponent<Button>().onClick,
                new UnityEngine.Events.UnityAction<bool>(comboBox.ToggleDropdownPanel), true);
            //Overlay Scroll Panel
            var overlayScrollPanelRT = overlayScrollPanel.GetComponent<RectTransform>();
            overlayScrollPanelRT.position += new Vector3(0, -cbbRT.sizeDelta.y, 0);
            overlayScrollPanelRT.anchorMin = new Vector2(0f, 1f);
        ...
        static public void AddDropDownList(MenuCommand menuCommand)
        {
            ...
            Events.UnityEventTools.AddBoolPersistentListener(mainButton.GetComponent<Button>().onClick,
                new UnityEngine.Events.UnityAction<bool>(dropDownList.ToggleDropdownPanel), true);
        ...
        private static void CreateToolTipItem(bool select) { CreateToolTipItem(select, null); }
        ...
        {
            GameObject reorderableScrollRoot
        ...
        {
            GameObject reorderableScrollRoot = CreateUIElementRoot("Re-orderable Horizontal ScrollRect", menuCommand,
        ...
        {
            GameObject reorderableScrollRoot
                = CreateUIElementRoot("Re-orderable Grid ScrollRect", menuCommand, s_ThickGUIElementSize);
        ...
        {
            GameObject reorderableScrollRoot
                = CreateUIElementRoot("Re-orderable Vertical List", menuCommand, s_ThickGUIElementSize);
