...
namespace UnityEngine.UI.Extensions
{
 ...
 (pSystem.simulationSpace == ParticleSystemSimulationSpace.Local ? particle.position : _transform.InverseTransformPoint(particle.position));
                ...
                if (textureSheetAnimation.enabled) {
                    ...
                    particleUV.y = 1.0f - ((frame / textureSheetAnimation.numTilesX) + 1) *
 ...
 (pSystem.simulationSpace == ParticleSystemSimulationSpace.Local ? particle.position : _transform.InverseTransformPoint(particle.position));
        ...
        public void StopParticleEmission() { pSystem.Stop(false, ParticleSystemStopBehavior.StopEmittingAndClear); }

        public void PauseParticleEmission() { pSystem.Stop(false, ParticleSystemStopBehavior.StopEmitting); }
    }
#endif
}